...
def register_tools( cfg: Config, client: HTTPClient) -> None:
    """
    ...
    if cfg.vufind_url:
        ...
        @app.get("/search_literature/{lookfor}")
    ...
    if cfg.vufind_url_article:
        @app.get("/search_article/{lookfor}")
    ...
    if cfg.vufind_url_frontend_article:
        @app.get("/frontend_link__article/{ppn}")
